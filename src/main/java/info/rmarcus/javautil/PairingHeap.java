...
/**
 * Implements a pairing heap. Supports a decreaseKey operation. Note that all
...
public class PairingHeap<AnyType extends Comparable<? super AnyType>> {
	...
	/**
	 * Insert into the priority queue, and return a Position that can be used by
	 ...
	 * 
	 * @param pos
	 *            any Position returned by insert.
	 * @param newVal
	 ...
	 *             if pos is null.
	 * @throws IllegalArgumentException
	 *             if new value is larger than old.
	 */
